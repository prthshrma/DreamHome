<%-- 
    Document   : DH_sellReview
    Created on : Jun 8, 2020, 8:22:26 PM
    Author     : HP
--%>
    ...
    <body>
        ...
        <div id="sellview">
            <div style="padding: 10px; ">
                <form action="SellReview" method="post">
                ...
                <table align="center" style="font-size: 15px; color:#3820E0;">    
                    ...
                    <tr><td>Price :</td><td><input type="number" name="price" value="<%=price%>" disabled="disabled"></td></tr>                                      
