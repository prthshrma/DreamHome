<%-- 
    Document   : DH_onrentView
    Created on : Jun 24, 2019, 9:49:22 AM
    Author     : HP
--%>
...
<html>
    ...
    <body>
        ...
        <h1 style="text-align: center; color:darkblue;">PROPERTY DETAIL</h1>
        ...
        <div id="toletview">
            <div style="padding: 10px; ">
                ...
                <table align="center" style="font-size: 15px; color:#3820E0;">    
                    ...
                    <tr><td>Preference :</td><td><input type="text" name="preference" value="<%=preference%>" disabled="disabled"></td></tr>
