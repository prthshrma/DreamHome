<%-- 
    Document   : DH_toletView
    Created on : Jun 8, 2019, 1:14:19 PM
    Author     : HP
--%>
...
<html>
    ...
    <body>
        ...
        <h1 style="text-align: center; color:darkblue;">PROPERTY VIEW</h1>
        ...
        <div id="toletview">
            <div style="padding: 10px; ">
                <form action="ToletUpdate" method="post" >
                <table align="center" style="font-size: 15px; color:#3820E0;">
                    ...
                    <tr><td>Built Up Area :</td><td><input type="text" name="builtuparea" value="<%=builtuparea%>" disabled="disabled"></td>
                        <td>Property Age :</td><td><input type="text" name="propertyage" value="<%=propertyage%>"></td></tr>
                </table>
                <table align="center" style="font-size: 15px; color:#3820E0;">    
                    ...
                    <tr><td>Rent :</td><td><input type="number" name="rent" value="<%=rent%>"></td></tr>                                      
                    <tr><td>Property Description :</td><td><textarea name="description" rows="4" cols="30" ><%=description%></textarea></td></tr>
                </table>
                <table align="center">    
