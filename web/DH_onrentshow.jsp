<%-- 
    Document   : DH_onrentshow
    Created on : Jun 23, 2019, 2:54:18 PM
    Author     : HP
--%>
...
<html>
    <head>
        ...
        <title>Show Rent Property</title>
    </head>
    <body>
        <%
        ...
        <div style="padding-top: 20px;">
            ...
            <div style="padding-top: 30px;">
                <%
                    ...
                    ArrayList<DTO> onrentlist=dao.getOnrentData(type, max, city);
                    if(!onrentlist.isEmpty())
                    {
                %>
            <div style="min-height: 100px; overflow: hidden; width: 800px; margin-left: auto; margin-right: auto; padding-top: 30px; background-color: white;">
                ...
                <table align="center" style="font-size: 12px; border-collapse: separate; border-spacing: 20px 0;">
                    <tr><th>Registry no.</th><th>Owner</th><th>Address</th><th>Rent</th></tr>
                    
                    <%
                        Iterator<DTO> showiterator=onrentlist.iterator();
                        
                        while(showiterator.hasNext())
                        {
                            dto=showiterator.next();
                    %>
                    <tr><td align="center"><%=dto.getRegistry()%></td> <td><%=dto.getOwner()%></td> <td><%=dto.getHouseno()%>,<%=dto.getColony()%>,<%=dto.getLandmark()%>,<%=dto.getCity()%>,<%=dto.getState()%></td> <td><%=dto.getRent()%></td>
                            <td><form action="Onrentview" method="post">
